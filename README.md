...
| Post Save Product     | Saves the product object into the product Table     |  /products/product | Body <pre>{<br>  "productname": "TEST TEST TEST TEST",<br>  "discription": "TEST TEST TEST TEST"<br>}</pre> |
